...
const Navbar = () => {
    ...
    return (
        <>
            <nav data-aos="zoom-out" dir='rtl' className=' w-[100%] h-[110px] bg-slate-100 p-5 top-[0] flex fixed z-50'>
                <Link className='flex-auto w-20' href='/'>
                    <Image width={80} height={10} src='/image/logojahan.png' className='w-[80px]' alt="Logo" />
                </Link>
                ...
                <div onClick={toggleModal} data-aos="zoom-out" className="hidden max-md:block relative w-12 h-12 mt-5 cursor-pointer bg-slate-800">
                    <Image width={80} height={10} src="/image/hamberger.png" alt="Navbar Toggle Icon" />
                </div>

      ...
      <div class="w-[100%]">
        <div class="flex justify-around gap-5 pb-5 text-center align-middle flex-wrap space-x-3 space-y-5">
          ...
          <div class="text-center space-y-5 mt-10">
            ...
            <p>09935566903</p> 
            <p>  09308716037</p>
            <a href="https://www.instagram.com/mohamad_jahan_536/"><p className="font-BNazanin font-bold">@mohamad_jahan_536</p></a>
          </div>
        </div>
        ...
        <div className="flex justify-around flex-wrap text-center   font-BMitra">
          ...
          <span>جهت ثبت سفارش طراحی سایت خود به صورت اختصاصی  به پیج ما مراجعه کنید <a className="text-blue-700" href='https://www.instagram.com/abolfazl_jahanbakhsh._.pv/'>پیج ما</a></span>
        </div>
      </div>

    ...
    <>
      ...
      <section dir='rtl'>
        <div className="relative main  mb-[5vh]">
          <h1 className="absolute text-[3vh]  w-[100%] p-1 text-center font-BTitrBd bg-gray-300 hover:bg-gray-400 top-[-12vh] z-10">بهترین مکانیکی در اصفهان با جهان تکنیک</h1>
          <Header />
        ...
        <Link className='block pt-12' id="darbareh" href="/aboutPage" aria-label="درباره ما">
          <Desc
            title="درباره ما"
        ...
        <Link className='block pt-12' id="address" href="/addressPage" aria-label="آدرس دقیق و مراجعه حضوری">
          <Desc
